...
static inline void mha_flashattention_2_fp32(mha_flashattention_2_layer_t layer, uint8_t num_heads, 
                                             uint32_t *W_O) {
    ...
    float *ConcatO_fa =
        (float *)snrt_l1_alloc_cluster_local(o_fa_size*num_heads, alignof(float));
